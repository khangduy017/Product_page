    ...
    <div className='SideBar'>
      <div className={'m1' + {}}>
        <div className='menu' onClick={() => handleMenu(1)}>
          ...
          <p className={`title ${(menu === 1) && 'choose'}`}>thông tin tài khoản</p>
        </div>
      ...
      <div className='menu m2' onClick={() => handleMenu(3)}>
        ...
        <p className={`title ${(menu === 3) && 'choose'}`}>lịch sử đơn hàng</p>
      </div>
      <div className='menu m3' onClick={() => handleMenu(4)}>
        ...
        <p className={`title ${(menu === 4) && 'choose'}`}>mã khuyến mãi</p>
      </div>
      <div className='menu m4' onClick={() => handleMenu(5)}>
        ...
        <p className={`title ${(menu === 5) && 'choose'}`}>đăng xuất</p>
      </div>
    </div>
  )
}

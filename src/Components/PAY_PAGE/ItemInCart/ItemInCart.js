...
export default function TagInCart(props) {
  ...
  return <div className={style.ItemInCart}>
    ...
    <svg onClick={() => sendAdd(props.i)} className={style.add} width="21" height="21" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <svg onClick={() => sendMinus(props.i)} className={style.reduce} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <svg className={style.note} width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">

    ...
    <div className={style.information}>
      ...
      <div className={style.section3}>
        <div className={style.note}>
          ...
          <textarea placeholder={"Ghi chú......."} className={style.mainNote} spellCheck={false}></textarea>
        </div>
      </div>
      <div className={style.section4}>
        <button onClick={() => pay([feeInt, amount, ''])} className={style.pay}>{feeInt + '.000'}đ - Thêm vào giỏ hàng</button>
      </div>
    </div>
  </div>
}
